package programs.Withoutcollections;

public class DataTypes {
	public static void main(String[] args) {
		byte byteValue = 101;// 1 byte
		short shortValue = 1234;// 2 bytes
		int intValue = 12345;// 4 bytes
		long longValue = 123456789875l;// 8 bytes
